...
const translations = {
    en: {
        ...
        cookieConsentText: "We use cookies and similar technologies to analyze website traffic and improve your experience. This includes Google Analytics for understanding how visitors use our site.",
        cookieConsentDetails: "You can accept all cookies or manage your preferences. You can change your settings at any time.",
        acceptAllCookiesText: "Accept All",
        acceptNecessaryCookiesText: "Necessary Only",
        manageCookiesText: "Manage Preferences",
        cookieSettingsTitle: "Cookie Preferences",
        necessaryCookiesTitle: "Necessary Cookies",
        necessaryCookiesText: "These cookies are essential for the website to function properly. They enable basic features like page navigation and access to secure areas.",
        analyticsCookiesTitle: "Analytics Cookies",
        analyticsCookiesText: "These cookies help us understand how visitors interact with our website by collecting and reporting information anonymously via Google Analytics.",
        saveCookiePreferencesText: "Save Preferences",
    ...
    gr: {
        ...
        cookieConsentTitle: "Συγκατάθεση Cookies",
        cookieConsentText: "Χρησιμοποιούμε cookies και παρόμοιες τεχνολογίες για να αναλύσουμε την κίνηση του ιστότοπου και να βελτιώσουμε την εμπειρία σας. Αυτό περιλαμβάνει το Google Analytics για την κατανόηση του τρόπου που οι επισκέπτες χρησιμοποιούν τον ιστότοπό μας.",
        cookieConsentDetails: "Μπορείτε να αποδεχτείτε όλα τα cookies ή να διαχειριστείτε τις προτιμήσεις σας. Μπορείτε να αλλάξετε τις ρυθμίσεις σας ανά πάσα στιγμή.",
        acceptAllCookiesText: "Αποδοχή Όλων",
        acceptNecessaryCookiesText: "Μόνο Απαραίτητα",
        manageCookiesText: "Διαχείριση Προτιμήσεων",
        cookieSettingsTitle: "Προτιμήσεις Cookies",
        necessaryCookiesTitle: "Απαραίτητα Cookies",
        necessaryCookiesText: "Αυτά τα cookies είναι απαραίτητα για τη σωστή λειτουργία του ιστότοπου. Επιτρέπουν βασικές λειτουργίες όπως η πλοήγηση στις σελίδες και η πρόσβαση σε ασφαλείς περιοχές.",
        analyticsCookiesTitle: "Cookies Αναλυτικών",
        analyticsCookiesText: "Αυτά τα cookies μας βοηθούν να κατανοήσουμε πώς οι επισκέπτες αλληλεπιδρούν με τον ιστότοπό μας συλλέγοντας και αναφέροντας πληροφορίες ανώνυμα μέσω του Google Analytics.",
        saveCookiePreferencesText: "Αποθήκευση Προτιμήσεων",
